...
public class Bomba extends Equipamento {
	...
	//
	public Bomba (String marca, String modelo,int anoFabricacao, Double valor, String pressaoSuccao, String pressaoDescarga, int taxaDeFluxo){
	...
	public String toString(){
		return "Dados do bomba" + "\n"+
				...
				"--> Valor: " + getValor() + "\n" +
				"--> Pressão de Sucçao: " + getPressaoSuccao() +"\n" +
